...
REPO="GoSungrow"
URL="https://api.github.com/repos/TrueMB/${REPO}/releases/latest"
...
# cd /tmp
# wget -O- https://github.com/TrueMB/GoSungrow/releases/download/v${GOSUNGROW_VERSION}/GoSungrow-linux_${ARCH}.tar.gz | tar zxvf - GoSungrow
